...
function Page() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Redirect will be handled by useEffect after session is updated
  };
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  ...
                  className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm bg-white hover:bg-gray-50 text-gray-700 font-medium text-sm transition-colors"
                >
