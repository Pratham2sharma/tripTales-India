                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                className="w-full flex justify-center items-center py-2 px-4 border border-gray-600 rounded-md shadow-sm bg-white hover:bg-gray-50 text-gray-900 font-medium text-sm transition-colors"
                            >
